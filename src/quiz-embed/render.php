<?php
/**
 * Server render for the quiz embed.
 *
 * @package D9QP
 *
...
if ( \D9QP\Post_Types::QUIZ !== \D9QP\Post_Types::valid_container( $d9qp_ref ) ) {
	if ( current_user_can( 'edit_posts' ) ) {
		echo '<p>' . esc_html__( 'Select a published quiz to embed.', 'interactive-quiz-poll' ) . '</p>';
	}
	return;
}
...
// Validate the questions against the referenced quiz, but track responses
// against the post this embed appears on.
...
$d9qp_wrapper = get_block_wrapper_attributes( array( 'class' => 'd9qp-embed d9qp-quiz-embed' ) );
